...
module.exports.statusPageSocketHandler = (socket) => {
    ...
    // honours that by setting isPublic = !socket.userID and filtering rows in
    // StatusPage.getIncidentHistory accordingly. Wrapping with onAuthed would
    // reject anonymous callers and break public status pages.
